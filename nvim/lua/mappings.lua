...
-- Grapple mappings
map("n", "<leader>hh", "<cmd>marks<cr>", { desc = "Toggle tags menu", silent = true })
map("n", "<C-1>", "<cmd>mark 1<cr>", { desc = "Set mark 1", silent = true })
map("n", "<C-2>", "<cmd>mark 2<cr>", { desc = "Set mark 2", silent = true })
map("n", "<C-3>", "<cmd>mark 3<cr>", { desc = "Set mark 3", silent = true })
map("n", "<C-4>", "<cmd>mark 4<cr>", { desc = "Set mark 4", silent = true })
map("n", "<C-5>", "<cmd>mark 5<cr>", { desc = "Set mark 5", silent = true })

map("n", "]g", ":diffget //2<CR>", { desc = "Get diff from previous commit" })
map("n", "[g", ":diffget //3<CR>", { desc = "Get diff from previous commit" })
...
map("n", "<leader>vd", ":DiffviewToggle<CR>", { desc = "Toggle Diffview", silent = true })
...
-- Prevent yanking on change (c, C) in normal and visual modes
